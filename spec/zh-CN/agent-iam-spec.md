...
> **已被取代。** 本单文档版本正在重组为多部分的
> [Agent IAM 系列](../README.zh-CN.md)：第 1 部分总体架构、第 2 部分注册与发现、
> 第 3 部分身份与认证、第 4 部分授权与委托、第 5 部分跨域联邦、第 6 部分审计与安全事件、
> 第 7 部分一致性与测试。本文件仅在迁移窗口期内保留。
> 详见 [`rfcs/0002-series-structure.md`](../../rfcs/0002-series-structure.md)。
