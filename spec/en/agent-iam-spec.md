...
This document distinguishes four kinds of identifiers:
...
- federation MUST preserve both parties' Authority Namespaces and maintain principal isolation per Section 16.2.
...
- Agent ID unique within its Authority Namespace;
...
8. the canonicalization of an Authority Namespace, the maximum Namespace depth, and its mapping to the identity-code levels of `GB/Z 185.2-2026`.
